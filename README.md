...
- [ITINERARY.md](ITINERARY.md) - the schedule
...
- [promo/INVITE.md](promo/INVITE.md) - group-chat copy without private contact details
- [calendar/justins-ocean-city-weekend.ics](calendar/justins-ocean-city-weekend.ics) - importable calendar
- [SOURCES.md](SOURCES.md) - research sources and verification dates

## Bingo cards

Print **14 copies** of [the finished bingo card](output/pdf/justins-bachelor-weekend-bingo-card.pdf): one for each of the 12 attendees plus 2 spares. Build and print instructions are in [print/README.md](print/README.md).
...
GitHub currently reports this repository as **private**. Keep [CONTACTS.md](CONTACTS.md), the rental address, booking details, and payment information inside the group. If the repository is ever made public, remove `CONTACTS.md` first. Only [promo/INVITE.md](promo/INVITE.md) is written for outside sharing.
