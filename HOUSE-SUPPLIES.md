...
This spreads the load and fits the four-car parking plan.

| Car | Proposed responsibility | Lead | Confirmed? |
| --- | --- | --- | --- |
...
| --- | ---: | --- | --- |
| Light beer | 2–3 cases | DMV Car A | No |
| Hard seltzer / canned cocktails | 2 cases mixed | DMV Car A | No |
| Vodka | 1 handle | DMV Car B | No |
| Tequila | 1 handle | DMV Car B | No |
| Whiskey / bourbon | 1 bottle or handle by demand | DMV Car B | No |
...
| Item | Starting quantity | Owner | Packed / bought |
| --- | ---: | --- | --- |
| Burger patties | 18–20 | Local grocery run | No |
| Hot dogs / sausages | 12–16 | Local grocery run | No |
| Burger and hot-dog buns | Match meat count | Local grocery run | No |
| Cheese, lettuce, tomato, onion, pickles | Group-size set | Local grocery run | No |
| Ketchup, mustard, mayo, BBQ sauce | 1 each | Local grocery run | No |
| Easy side: potato/pasta salad | 2 large tubs | Local grocery run | No |
| Grill tools / propane confirmation | Check listing/host first | TBD | No |

## Breakfast and brunch

| Item | Weekend quantity | Owner | Packed / bought |
| --- | ---: | --- | --- |
...
The Airbnb lists trash bags, paper towels, dishware, dishwasher, and laundry detergent, but backup supplies avoid a bad Sunday.

| Item | Quantity | Owner | Packed / bought |
| --- | ---: | --- | --- |
| Paper towels | 4 backup rolls | TBD | No |
| Trash bags | 1 backup box | TBD | No |
| Toilet paper | 12-roll backup pack | TBD | No |
| Foil / zip bags / food containers | 1 each | TBD | No |
